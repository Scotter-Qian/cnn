...
#定义训练函数
    def train(self):
        ...
        train_loss_list = []
        train_accuracy_list = []
        f1 = open(r"E:\CNN\VGGNet16_train_loss", "w")
        f2 = open(r"E:\CNN\VGGNet16_train_error", "w")
        f3 = open(r"E:\CNN\VGGNet16_test_error", "w")
...
if __name__ == "__main__":
    model_output = SelectModel(num_classes=2,
                               ...
                               epoch_num=30,
                               batch_size=30,
                               model_path="./VGG16")#batch_size 设置为64时会出现OOM错误
